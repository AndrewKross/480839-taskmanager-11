...
class Provider {
  ...
  getTasks() {
    ...
    return Promise.resolve(_models_task__WEBPACK_IMPORTED_MODULE_0__["default"].parseTasks(storeTasks));
  }
  ...
  createTask(task) {
    ...
    const localNewTaskId = Object(nanoid__WEBPACK_IMPORTED_MODULE_1__["nanoid"])();
    const localNewTask = _models_task__WEBPACK_IMPORTED_MODULE_0__["default"].clone(Object.assign(task, {id: localNewTaskId}));
  ...
  updateTask(id, task) {
    ...
    const localTask = _models_task__WEBPACK_IMPORTED_MODULE_0__["default"].clone(Object.assign(task, {id}));
...
/* harmony import */ var _controllers_board_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./controllers/board.js */ "./src/controllers/board.js");
...
/* harmony import */ var _components_site_menu_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/site-menu.js */ "./src/components/site-menu.js");
...
/* harmony import */ var _models_tasks_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./models/tasks.js */ "./src/models/tasks.js");
...
const apiWithProvider = new _api_provider_js__WEBPACK_IMPORTED_MODULE_2__["default"](api, store);
const tasksModel = new _models_tasks_js__WEBPACK_IMPORTED_MODULE_8__["default"]();

const siteMainElement = document.querySelector(`.main`);
const siteHeaderElement = siteMainElement.querySelector(`.main__control`);
const siteMenuComponent = new _components_site_menu_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
const statisticsComponent = new _components_statistics_js__WEBPACK_IMPORTED_MODULE_7__["default"]({tasks: tasksModel, dateFrom, dateTo});

const boardComponent = new _components_board_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
const boardController = new _controllers_board_js__WEBPACK_IMPORTED_MODULE_4__["default"](boardComponent, tasksModel, apiWithProvider);
const filterController = new _controllers_filter_js__WEBPACK_IMPORTED_MODULE_5__["default"](siteMainElement, tasksModel);

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(siteHeaderElement, siteMenuComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].BEFOREEND);
filterController.render();
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(siteMainElement, boardComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].BEFOREEND);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(siteMainElement, statisticsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].BEFOREEND);
statisticsComponent.hide();

siteMenuComponent.setOnChange((menuItem) => {
  switch (menuItem) {
    case _components_site_menu_js__WEBPACK_IMPORTED_MODULE_6__["MenuItem"].NEW_TASK:
      siteMenuComponent.setActiveItem(_components_site_menu_js__WEBPACK_IMPORTED_MODULE_6__["MenuItem"].TASKS);
      statisticsComponent.hide();
      boardController.show();
      boardController.createTask();
      break;
    case _components_site_menu_js__WEBPACK_IMPORTED_MODULE_6__["MenuItem"].STATISTICS:
      boardController.hide();
      statisticsComponent.show();
      break;
    case _components_site_menu_js__WEBPACK_IMPORTED_MODULE_6__["MenuItem"].TASKS:
      statisticsComponent.hide();
      boardController.show();
      break;
  }
